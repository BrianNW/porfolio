...
export default function MobileServicesTitleModal() {
    ...
    >
      {open && (
        <div className="relative w-full h-full flex flex-col items-center justify-center">
          ...
          <h2 className="text-4xl font-extrabold capitalize tracking-tight text-[#4c1d95] dark:text-zinc-100 text-center mb-0">Services</h2>
        </div>
      )}
    </div>
  );
